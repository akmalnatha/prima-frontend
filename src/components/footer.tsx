function Footer() {
  return (
    <>
      <footer className="bottom-0 w-full bg-gradient-to-b from-blue-primary to-[#3083D5] rounded-t-3xl pt-12 pb-12 px-8 lg:px-20 z-40">
        <div className="w-full flex flex-col lg:flex-row lg:justify-between gap-6 z-40">
