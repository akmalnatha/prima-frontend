    ...
    <>
      ...
      <div className="max-w-screen w-full h-full flex flex-col px-10 lg:px-28 mb-[100px] md:mb-[200px] overflow-hidden">
        ...
        <p className="mt-10 font-medium text-[16px] lg:text-[24px] text-justify">
          PRIMA 2023 adalah singkatan dari Pameran Riset, Inovasi dan Pengabdian
          ...
          di masa medatang. PRIMA 2023 dialksanakan oleh panitia di lingkungan
          ...
          dan inovasi dosen ITB sepanjang tahun 2023 yang dipamerkan dalam
          galeri virtual mulai tanggal 20 Desember 2023 dan dapat terus diakses
          sepanjang tahun.
          <br />
          <br />
          Selain acara pameran virtual, pada 20 Desember 2023 diselenggarakan
          juga rangkaian talkshow yang menarik hingga sore hari. Besoknya 21
          Desember 2023 diselenggarakan konferensi ilmiah The 3rd ITB-Graduate
          School Conference 2023 hasil kerjasama Sekolah Pascasarjana ITB dan
          LPPM ITB.
        </p>
      </div>
      <Footer />
